...
400 Bad Request	Ungültige Anfrage	Parameter fehlen oder sind ungültig.
401 Unauthorized	Zugriff verweigert	API-Key fehlt oder ist ungültig.
404 Not Found	Nicht gefunden	Angegebener Ort konnte nicht gefunden werden.
429 Too Many Requests	Ratenlimit überschritten	Standard: 60 Requests / Minute.
500 Internal Server Error	Serverfehler	Unerwarteter Serverfehler.
...
Invoke-RestMethod -Uri "https://api.simpleweather.example/v1/weather/current?city=Hamburg" `
  -Headers @{ Authorization = "Bearer YOUR_API_KEY" }
